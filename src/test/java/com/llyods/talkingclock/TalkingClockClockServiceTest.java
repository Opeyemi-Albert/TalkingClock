...
class TalkingClockClockServiceTest {
  ...
  @InjectMocks private TalkingClockServiceImpl talkingClockService;
  ...
  public void testGetTalkingClockValueMethodWithValidInputs() {
    ...
    Map<String, String> result = talkingClockService.getTalkingClockValue(clockDigits);
  ...
  void testConvertToHumanFriendlyTextMethodWithValidInput() {
    ...
    // Test valid input
    assertEquals("Half past Twelve ", talkingClockService.convertToHumanFriendlyText("12:30"));
    assertEquals("One o'clock ", talkingClockService.convertToHumanFriendlyText("01:00"));
    assertEquals("Ten to Twelve ", talkingClockService.convertToHumanFriendlyText("11:50"));
  }
  ...
  void testConvertToHumanFriendlyTextMethodWitOutOfRangeHourInput() {
    ...
    try {
      ...
      assertEquals("Invalid hour. Hour should be between 0 and 23.", e.getMessage());
    }
  }
