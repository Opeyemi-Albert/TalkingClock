...
public class Config {
	...
	public static final String[] HOUR_WORDS = { "Twelve", "One", "Two", "Three", "Four",
			"Five", "Six", "Seven", "Eight", "Nine", "Ten", "Eleven", "Twelve" };

	public static final String[] MINUTE_WORDS = { "", "Five", "Ten", "Fifteen", "Twenty",
			"Twenty five", "Half", "Twenty five", "Twenty", "Fifteen", "Ten", "Five" };
